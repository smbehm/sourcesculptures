...
const sections = [
  ...
  },
  {
    ...
    body: (
      <>
        Sean Behm is a visionary designer, fabricator, and entrepreneur known for bringing ambitious ideas into physical reality at scale. As a partner and senior designer at <a href="https://miamidesignshop.com" target="_blank" rel="noopener noreferrer" className="underline underline-offset-4 hover:text-foreground transition-colors">Miami Design Shop</a> and Co-Founder and Playa architect of <a href="https://kazbah.org" target="_blank" rel="noopener noreferrer" className="underline underline-offset-4 hover:text-foreground transition-colors">The Kazbah</a>, Sean operates at the intersection of architecture, art, experiential design and fabrication, crafting environments that are as technically refined as they are emotionally impactful.
        <br /><br />
